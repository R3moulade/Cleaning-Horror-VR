...
public void SetupPose(BaseInteractionEventArgs arg)
{
    ...
    {
        if(arg.interactorObject.transform != null)
        {
            ...
            {
                Debug.LogError("HandData component not found in the children of the interactor object." + arg.interactorObject.transform.name);
            }
        }
        else
        {
            Debug.LogError("Interactor object's transform is null.");
        }
    }
}
public void UnSetPose(BaseInteractionEventArgs arg) 
{
    if (arg.interactorObject is XRDirectInteractor)
    {
        if(arg.interactorObject.transform != null)
        {
            ...
            {
                Debug.LogError("HandData component not found in the children of the interactor object.");
            }
        }
        else
        {
